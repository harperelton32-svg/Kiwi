/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: cc50cacffcff5f2b8a9ba385157ddde0)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		WORKER_SELF_REFERENCE: Fetcher /* kiwi */;
	}
}
